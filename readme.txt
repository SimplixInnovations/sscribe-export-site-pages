...
= 2.0.4 =
* Hardened deterministic WordPress.org packaging and fail-closed release tagging.
* Improved large-site query/cache/lock performance and SQLite upgrade recovery.
* Fixed admin keyboard, focus, live-region, tab, and dismissal behavior; tested on WordPress 7.1.2.
...
= 2.0.4 =
Release, runtime, performance, migration, and accessibility hardening; no manual data migration required.
