...
if ( $strict_certification ) {
	...
	$record(
		...
		'Strict certification requires a clean working tree (including non-ignored untracked files). Commit or discard tracked changes before building release evidence.'
	);
