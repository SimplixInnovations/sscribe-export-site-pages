 ...
 * Run: php scripts/bump-version.php 3.42.0
 *
 * @package SScribe
 */
...
if ( $argc < 2 ) {
	...
	echo "Example: php scripts/bump-version.php 3.42.0\n";
	exit( 1 );
}
...
if ( ! preg_match( '/^\d+\.\d+\.\d+$/', $new_version ) ) {
	echo "Error: Version must be in format major.minor.patch (e.g., 3.42.0)\n";
	exit( 1 );
}
