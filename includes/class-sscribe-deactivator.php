...
class SScribe_Deactivator {
	...
	public static function deactivate(): void {
		...
		//
		// Version history: Prior to 1.1.4, the deactivator dropped sscribe_sessions
		// and sscribe_export_stats tables. This was changed in 1.1.4 to preserve
	...
	/**
	 * Remove plugin tables — REMOVED in 1.1.4.
	 *
