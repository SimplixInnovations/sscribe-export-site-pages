 ...
 *
 * Phase 16: locks the "single source of truth" contract for the
 * plugin's version metadata.
 *
 ...
 *
 * This test reads the four locations from disk (no PHP-side caching)
 * so a regression that updates one but not the others fails the
 * suite immediately.
 */
